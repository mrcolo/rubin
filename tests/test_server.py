    ...
    def test_initialize_and_list(self):
        ...
        self.assertEqual(
            ...
            {"compose_midi", "import_midi", "compose_and_import", "open_midi_as_project",
             ...
             "transcribe_audio", "list_transcriptions", "analyze_midi", "import_audio", "catalog_samples", "reveal_in_finder", "cut_samples", "render_midi_audio", "analyze_audio",
             "answer_dialog", "save_project", "list_plugins", "verify_track_readback", "find_channel_strips",
